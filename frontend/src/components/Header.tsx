  ...
  return (
    <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
      ...
      <Dialog.Root>
        ...
        {/* Portal joga o conteudo modal p fora da aplicaçao */}
        <Dialog.Portal>
          <Dialog.Overlay
            className='w-screen h-screen bg-black/80 fixed inset-0'
          />
          <Dialog.Content
            className='absolute p-10 bg-zinc-900 rounded-2xl 
            w-full max-w-md top-1/2 left-1/2
          ...
          >
            ...
            <Dialog.Title className='text-1 xl leading-tight font-bold'>
              Criar hábito
            </Dialog.Title>
            <NewHabitForm />
